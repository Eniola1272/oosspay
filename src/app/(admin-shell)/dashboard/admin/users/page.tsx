            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-[#E0E0E0]">
                {loading ? Array.from({ length: 6 }).map((_, i) => (
                  ...
                  <tr key={u.id} className="hover:bg-[#FAFAFA] cursor-pointer" onClick={() => router.push(`/dashboard/admin/users/${u.id}`)}>
                    ...
                    <td className="px-4 py-3">
                      <Badge className={u.role === "admin" || u.role === "super_admin" ? "bg-[#C2185B] text-white text-[10px]" : "bg-[#E0E0E0] text-[#666666] text-[10px]"}>
                        {u.role}
                      </Badge>
                    </td>
                    <td className="px-4 py-3">
